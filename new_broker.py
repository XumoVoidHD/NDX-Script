...
class IBTWSAPI:
    ...
    async def get_latest_premium_price(self, symbol, expiry, strike, right, exchange="SMART", print_data=False):
        ...
        option_contract = Option(
            ...
            # tradingClass="RUT",  # Specify tradingClass (e.g., SPXW or SPX)
        )

        qc = self.client.qualifyContracts(option_contract)

        self.client.reqMarketDataType(1)
        market_data = self.client.reqMktData(option_contract, "", False)
